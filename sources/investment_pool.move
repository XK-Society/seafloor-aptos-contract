module crab_project::investment_pool {
    ...
    public entry fun withdraw(admin: &signer, investor: address, amount: u64) acquires LiquidityPool {
    ...
    // Additional function to handle CRAB token burning
    public entry fun burn_crab_tokens(investor: &signer, amount: u64) {
